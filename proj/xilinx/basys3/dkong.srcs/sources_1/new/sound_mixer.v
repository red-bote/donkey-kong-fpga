...
// Engineer: 
// 
// Create Date: 09/01/2024 10:43:07 AM
// Design Name: 
...
wire signed [15:0]WAVROM_DS[0:3]; // DK only uses 3 samples
wire        [15:0]WAVROM_A[0:3]; // DK only uses 3 samples
...
// W_6H_Q[7] selects climbing sound (DKjr only)
...
(
    ...
    .I_DMA_STOP(1'b0),
    .I_DMA_CHAN(3'd0),
//  .I_DMA_ADDR({2'b00, W_6H_Q[7] ? multsample : multsample+3, 11'h000}), // 00nn n000 0000 0000  2048=$0800
    .I_DMA_ADDR({2'b00, multsample, 11'h000}),
    .I_DMA_LEN(16'h0800),
